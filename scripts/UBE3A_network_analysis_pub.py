...
def get_UBE3A_network(source_networks,seed_genes,entrez_file,seed_gene_file,complete_prey_file,out_prefix):
	...
	network_classes_igraph_pub.add_node_attributes(gsub_sn2s,seed_gene_file,[3,4,5,6,7])
	...
	gsub_sn2s.update_node_attribute('source',['7337'],'bait')
...
if __name__ == '__main__':
	...
	### build network for preys and all neighbors linked to 2 seeds including proteasome related preys, QBCHL as source,
	### keep only edges with at least 2 evidences
	out_prefix = 'UBE3A_proteasome_network_QBCHL'
	source_networks = [bioplex_tup,ccsb_tup,litbm_tup,qubic_tup,cofrac_tup]
	get_UBE3A_network(source_networks,prot_seed_genes,entrez_file,complete_prey_file,complete_prey_file,out_prefix)
